...
const GROUPS = [
  {
    label: "FEATURES",
    items: [
      { label: "Bexxa AI Assistant", to: "/bexxa-assistant", icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none"><rect x="9" y="2" width="6" height="11" rx="3" stroke="currentColor" strokeWidth="2"/><path d="M5 10a7 7 0 0 0 14 0" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/></svg> },
